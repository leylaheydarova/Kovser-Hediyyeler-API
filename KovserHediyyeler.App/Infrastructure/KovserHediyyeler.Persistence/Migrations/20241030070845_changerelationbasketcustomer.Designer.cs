...
namespace KovserHediyyeler.Persistence.Migrations
{
    ...
    [Migration("20241030070845_changerelationbasketcustomer")]
    partial class changerelationbasketcustomer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KovserHediyyeler.Domain.Models.Identity.WebUser", b =>
                {
                    b.HasOne("KovserHediyyeler.Domain.Models.Basket", "Basket")
                        .WithOne("Customer")
                        .HasForeignKey("KovserHediyyeler.Domain.Models.Identity.WebUser", "BasketID")
                        .OnDelete(DeleteBehavior.NoAction);
