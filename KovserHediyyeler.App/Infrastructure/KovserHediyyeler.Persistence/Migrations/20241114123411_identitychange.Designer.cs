...
namespace KovserHediyyeler.Persistence.Migrations
{
    ...
    [Migration("20241114123411_identitychange")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KovserHediyyeler.Domain.Models.Endpoint", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EndpointRole", b =>
                {
                    b.HasOne("KovserHediyyeler.Domain.Models.Endpoint", null)
                        .WithMany()
                        .HasForeignKey("EndpointsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KovserHediyyeler.Domain.Models.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("KovserHediyyeler.Domain.Models.Endpoint", b =>
                {
                    b.HasOne("KovserHediyyeler.Domain.Models.Menu", "Menu")
                        .WithMany("Endpoints")
