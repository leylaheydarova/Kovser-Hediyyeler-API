...
namespace KovserHediyyeler.Persistence.Services
{
    public class RoleService : IRoleService
    {
        ...
        {
            IdentityResult result = await _roleManager.CreateAsync(new() { Id = Guid.NewGuid().ToString(), UserName = name });
        ...
        public (object, int) GetAllRoles(int page, int size)
        {
            ...
            IQueryable<UserRole> rolesQuery = null;
            ...
            return (rolesQuery.Select(r => new { r.Id, r.UserName }), query.Count());
        }
