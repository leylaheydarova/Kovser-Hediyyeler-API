...
namespace KovserHediyyeler.Infrastructure.Services.Configurations
{
    public class ApplicationService : IApplicationService
    {
        List<MenuDto> IApplicationService.GetAuthorizeDefinitionEndpoints(Type type)
        {
                    ...
                    if (actions != null)
                        foreach (var action in actions)
                        {
                            ...
                            if (attributes != null)
                            {
                                ...
                                KovserHedieyyeler.Application.DTOs.Configuration.Action _action = new()
                                {
