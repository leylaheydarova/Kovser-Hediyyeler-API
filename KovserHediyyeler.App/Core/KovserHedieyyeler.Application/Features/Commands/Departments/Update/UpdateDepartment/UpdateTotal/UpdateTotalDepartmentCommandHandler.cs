...
namespace KovserHedieyyeler.Application.Features.Commands.Departments.Update.UpdateDepartment.UpdateTotal
{
    public class UpdateTotalDepartmentCommandHandler : IRequestHandler<UpdateTotalDepartmentCommandRequest, UpdateTotalDepartmentCommandResponse>
    {
        ...
        public UpdateTotalDepartmentCommandHandler(IDepartmentReadRepository readRepository, IDepartmentWriteRepository writeRepository, IHttpContextAccessor accessor, ISocialMediaReadRepository socialMediaReadRepository, ISocialMediaWriteRepository socialMediaWriteRepository, ISocialMediaWriteRepository smRepository)
        {
